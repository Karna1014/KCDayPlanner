...
$("#save9").on('click', function() {
    ...
    //if (currentTime < time slot highlight all as future events)
    //else if  (currentTime = time slot highlight input as current event)
    //else(highlight input as past event) 
    // var currentHour = parseInt('19');  for testing purposes
            ...
            hoursInDay.forEach(function(hour) {
                ...
                if (currentHour < hour) {
                    document.getElementById("myInput" + hourBadge.toString()).style.backgroundColor = "mediumaquamarine";
                    
                } else if (currentHour === hour) {
                    document.getElementById("myInput" + hourBadge.toString()).style.backgroundColor = "rgb(226, 238, 56";

                } else {
                    document.getElementById("myInput" + hourBadge.toString()).style.backgroundColor = "#a7490681";
